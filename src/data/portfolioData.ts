// Datos completos estructurados del Dr. Carlos Giovanni González Espitia
// Extraídos y normalizados a partir del sitio original giovannigonzalez.com
...
export const portfolioData = {
  "professor": {
    ...
    "bio": "Full Professor of Economics in the Department of Economics at Universidad Icesi (School of Business and Economics, AACSB and AMBA accredited) in Cali, Colombia. Researcher specializing in Applied Econometrics, Economics of Education, Economics of Crime, and Entrepreneurship. Member of the research group 'Economics, Public Policies and Quantitative Methods' (Ranked A1 by MinCiencias). Editor-in-Chief of Icesi Economics Working Papers and actively teaches both undergraduate and graduate (Master, MBA, and PhD) courses with approximately 500 hours per year.",
    "contact": {
    ...
    "affiliations": [
      {
        "name": "The Econometric Society",
        "url": "http://www.econometricsociety.org/"
      },
      {
        "name": "LACEA (Latin American and Caribbean Economic Association)",
        "url": "http://www.lacea.org/portal/"
      },
      {
        "name": "AEDE (Economics of Education Association) - Scientific Committee",
        "url": "https://economicsofeducation.com/en/"
      },
      {
        "name": "CONALPE (Consejo Nacional Profesional de Economía)",
        "url": "https://www.conalpe.gov.co/"
      },
      {
        "name": "CLADEA (Consejo Latinoamericano de Escuelas de Administración)",
        "url": "https://www.cladea.org/"
      },
      {
        "name": "BALAS (Business Association of Latin American Studies)",
    ...
    "skills": [
      {
        "name": "Stata",
        "category": "Econometrics & Panel Data",
        "level": "Expert"
      },
      {
        "name": "R & RStudio",
        "category": "Statistical Computing & Visualization",
        "level": "Expert"
      },
      {
        "name": "Python",
        "category": "Data Science & Spatial Modeling",
        "level": "Advanced"
      },
      {
        "name": "LaTeX & Overleaf",
        "category": "Scientific Publishing & Typesetting",
        "level": "Expert"
      },
      {
        "name": "Applied Spatial Econometrics",
        "category": "Durbin & Spatial Lag Models",
        "level": "Expert"
      }
    ]
  },
